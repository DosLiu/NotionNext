...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dosen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '数字游民', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '游记，环游世界，工作，人生，Notion, 博客', // 网站关键词 英文逗号隔开
